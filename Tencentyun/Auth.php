...
class Auth
{
     ...
     * @return string             签名
     */
    public static function appSign_once($fileId, $bucketName) {
        ...
        return self::appSign($appId, $secretId, $secretKey, 0, $fileId, $bucketName);
    }
     ...
     * @return string          签名
     */
    public static function appSign_more($expired, $bucketName) {
        ...
        return self::appSign($appId, $secretId, $secretKey, $expired, null, $bucketName);
    }
     ...
     * @return string             签名
     */
    private static function appSign($appId, $secretId, $secretKey, $expired, $fileId, $bucketName) {
